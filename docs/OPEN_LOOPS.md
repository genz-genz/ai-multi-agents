...
| ID | Task | Closed |
|---|---|---|
| L13 | e2e เคส XSS: รัน server e2e ด้วย `TRUST_PROXY=1` (เหมือน prod) แล้ว seed เป็นผู้ชมอีก IP · ไม่มี env = skip (พิสูจน์ว่า XFF ปลอมข้าม rate limit ไม่ได้แล้ว) · `test:e2e` 6/6 | 2026-09-25 |
